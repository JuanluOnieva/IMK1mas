...
var tip_box_input=document.getElementById(`input-tip${id}`);tip_box_input.value=fundraiser_donation_values_response.data.tip_amount.default_values.tip_amount_fixed_default;if(dropDownValue=='Amount'&&selectedValue>=100000){calculateTotalAmountDropDown(id,selectedValue*0.0);}else if(dropDownValue=='Amount'&&selectedValue<1000000){calculateTotalAmountDropDown(id,fundraiser_donation_values_response.data.tip_amount.tip_amount_fixed.third_option);}else{calculateTotalAmountDropDown(id,dropDownValue);}}
